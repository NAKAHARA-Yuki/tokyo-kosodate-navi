...
//       src/components/ChipLabel/ChipLabel.tsx （commit 88110f7, package v2.7.0）
...
const colorClasses: Record<ChipLabelVariant, Record<ChipLabelColor, string>> = {
  ...
  outlined: {
    gray: "border-solid-gray-700 text-solid-gray-800 bg-[var(--background)]",
    blue: "border-blue-700 text-blue-700 bg-[var(--background)]",
    "light-blue": "border-light-blue-800 text-light-blue-800 bg-[var(--background)]",
    cyan: "border-cyan-900 text-cyan-900 bg-[var(--background)]",
    green: "border-green-800 text-green-800 bg-[var(--background)]",
    lime: "border-lime-900 text-lime-900 bg-[var(--background)]",
    yellow: "border-yellow-1000 text-yellow-1000 bg-[var(--background)]",
    orange: "border-orange-900 text-orange-900 bg-[var(--background)]",
    red: "border-red-900 text-red-900 bg-[var(--background)]",
    magenta: "border-magenta-800 text-magenta-800 bg-[var(--background)]",
    purple: "border-purple-800 text-purple-800 bg-[var(--background)]",
  },
  "filled-1": {
